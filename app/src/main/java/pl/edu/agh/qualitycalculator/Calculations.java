...
public class Calculations {
    ...
    private float sum(float operand1, float operand2, float operand3) { return operand1 + operand2 + operand3; }

    private float subtract(float operand1, float operand2, float operand3) { return operand1 - operand2 - operand3; }

    private float multiply(float operand1, float operand2, float operand3) { return operand1 * operand2 * operand3; }

    private float divide(float operand1, float operand2, float operand3) { return operand1 / operand2 / operand3; }
